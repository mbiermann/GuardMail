...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: aBC9ACNQFg7W/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg__ay43H)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__imbPx)}
              role={"img"}
            />
          ),
