...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 21fIsfPRr3kA/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__aZbn)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__yzPvc)}
                role={"img"}
              />
            ),
